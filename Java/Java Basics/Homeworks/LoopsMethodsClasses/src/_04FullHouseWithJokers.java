 ...
 * A special card "Joker" (denoted as "*") is used as wildcard and can replace any other card. Jokers do not have a suite. 
 * Jokers can be used several times in a hand. Write a program to generate and print all full houses and print their number. */
