/* Each office puts in this Excel file all their incomes. Your task is to read the report and to calculate the 
 * incomes sub-totals for each office (with VAT). Order the offices alphabetically. Print the result at the console in 
 * format town Total -> incomes. Finally calculate and print the grand total. */

/* For right execution of the program we need the following files from Apache-POI Library: 
 * dom4j-1.6.1.jar
